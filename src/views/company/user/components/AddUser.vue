      ...
      <a-row type="flex" justify="center">
        <a-col :span="12">
          <a-form layout="vertical">
            ...
            <a-form-item :label-col="{ span: 4 }" :wrapper-col="{ span: 16 }" :label="`真实姓名`">
              <a-input
                v-decorator="[
                ` `,
                {
            ...
            <a-form-item :label-col="{ span: 4 }" :wrapper-col="{ span: 16 }" :label="`联系方式`">
              <a-input
                v-decorator="[
                ` `,
                {
    ...
    <div class="card-warp">
      ...
      <div>
        <a-row type="flex" justify="center">
          <a-col :span="12">
            <a-form layout="vertical">
              <a-form-item :label-col="{ span: 4 }" :wrapper-col="{ span: 16 }" :label="`机构`">
        ...
        <a-row type="flex" justify="center">
          <a-col :md="12">
            <a-form layout="vertical">
              ...
              <a-form-item :label-col="{ span: 4 }" :wrapper-col="{ span: 16 }" label="用户名">
                <a-input placeholder="给自己起个名字" />
              </a-form-item>
              <a-form-item :label-col="{ span: 4 }" :wrapper-col="{ span: 16 }" label="性别">
                <a-radio-group v-model="userType">
